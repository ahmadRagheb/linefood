...
window.onload = function() {
	$.ajax({
		url: "http://localhost:8000/api/method/linefood.www.marks.marks.get_Product_by_trade_mark",
		method: 'POST',
		data: {
			name: news_name
		},
...
window.onload = function() {
	$.ajax({
		url: "http://localhost:8000/api/method/linefood.www.news.news.get_news",
		method: 'POST',
		data: {
				name: news_name
		},
